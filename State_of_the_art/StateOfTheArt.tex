This chapter illustrates the main dynamic system paradigms that today guide the research toward better certification schemes. The following sections include an overview of such systems and the progressive integration of the certification schemes that allows them to prove their trustworthiness. Furthermore, we illustrate the history of the certification schemes, where they arrived today and how they are evolving in the research environment; we also introduce the major current efforts in such field and highlight the gaps this thesis is willing to explore.
